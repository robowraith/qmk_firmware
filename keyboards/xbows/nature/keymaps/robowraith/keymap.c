...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_NUMBERS] = LAYOUT(
      ...
      RALT(DE_1),KC_LGUI,  KC_LALT,  KC_LCTL,  KC_LSFT,  KC_VOLD,TG(_NUMBERS),DE_SLSH,  TD(F4_4), TD(F5_5),  TD(F6_6),  TD(F11_DO),TD(F10_PL),XXXXXXX,            XXXXXXX,
  ...
  [_NAVIGATION] = LAYOUT(
      ...
      KC_NO,     KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,               KC_NO,    KC_NO,    KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_NO,    KC_NO,
	    ...
	    KC_PASTE,  KC_COPY,  KC_LEFT,  KC_DOWN,  KC_RGHT,KC_PGDN,TG(_NAVIGATION),KC_NO,    KC_RSFT,  KC_RCTL,   KC_RALT,   KC_RGUI,   G(KC_5),   XXXXXXX,            XXXXXXX,
