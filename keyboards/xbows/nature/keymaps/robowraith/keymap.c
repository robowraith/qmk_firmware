...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_NUMBERS] = LAYOUT(
      ...
      XXXXXXX,   LCOFF,    LCON,     KC_MPRV,  KC_MNXT,  KC_MPLY,   XXXXXXX,  DE_COLN,  TD(F1_1), TD(F2_2),  TD(F3_3),  TD(F12_CO),XXXXXXX,             XXXXXXX,
  ...
  [_NAVIGATION] = LAYOUT(
      ...
      XXXXXXX,   KC_PASTE, KC_CUT,   KC_VOLD,  KC_VOLU,  KC_PSCR,   XXXXXXX,  KC_NO,    KC_NO,    KC_NO,     KC_NO,     KC_NO,     XXXXXXX,             XXXXXXX,
