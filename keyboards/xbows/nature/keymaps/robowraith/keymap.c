...
[_NUMBERS] = LAYOUT(
      XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,  XXXXXXX,
      XXXXXXX,  RALT(DE_1),RALT(DE_2),RALT(DE_3),KC_NO,  KC_MUTE,             DE_MINS,  TD(F7_7), TD(F8_8),  TD(F9_9),  TD(F10_PL),XXXXXXX,   XXXXXXX,  XXXXXXX,
      XXXXXXX,   KC_LGUI,  KC_LALT,  KC_LCTL,  KC_LSFT,  KC_ESC,              DE_SLSH,  TD(F4_4), TD(F5_5),  TD(F6_6),  TD(F11_DO),XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,
      XXXXXXX,   LCOFF,    LCON,     KC_MPRV,  KC_MNXT,  KC_MPLY,   XXXXXXX,  DE_COLN,  TD(F1_1), TD(F2_2),  TD(F3_3),  TD(F12_CO),XXXXXXX,   XXXXXXX,            XXXXXXX,
      XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_NO,    KC_NO,     XXXXXXX,  KC_ENTER,  KC_NO,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,             XXXXXXX,
...
[_NAVIGATION] = LAYOUT(
      ...
      XXXXXXX,   KC_COPY,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_PGDN,             KC_TAB,   KC_RSFT,  KC_RCTL,   KC_RALT,   KC_RGUI,   XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,
      XXXXXXX,   KC_PASTE, KC_CUT,   KC_VOLD,  KC_VOLU,  KC_PSCR,   XXXXXXX,  KC_NO,    KC_NO,    KC_NO,     KC_NO,     KC_NO,     XXXXXXX,   XXXXXXX,            XXXXXXX,
      XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_NO,    KC_DEL,    XXXXXXX,  KC_ENT,   KC_NO,    XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,             XXXXXXX,
